<template>
    <div class="max-w-screen py-4 flex flex-row flex-wrap justify-center items-center bg-teal-400">
        ...
        <div class="md:order-3 basis-1/2 md:basis-1/4 text-end pr-8 md:text-3xl text-2xl">
